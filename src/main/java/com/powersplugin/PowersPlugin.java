...
public class PowersPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getLogger().info("====================================");
        getLogger().info("  PowersPlugin v2.0.0 Enabled!");
        getLogger().info("  Celestial Judgment Sword (Boss Drop Only)");
        getLogger().info("  Full God Armor Set | Power Apples x2");
        getLogger().info("  Ancient Guardian Boss");
        getLogger().info("====================================");
    }
