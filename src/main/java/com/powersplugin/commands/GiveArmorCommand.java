...
public class GiveArmorCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        target.getInventory().addItem(plugin.getCraftingManager().createGodArmor());
        sender.sendMessage("§aGave God Chestplate to " + target.getName());
        target.sendMessage("§b§l✦ You received the God Chestplate! ✦");
        return true;
    }
}
